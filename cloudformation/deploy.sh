...
"C:\Program Files\Amazon\AWSSAMCLI\bin\sam.cmd" deploy -t main.yml --stack-name $project_name --capabilities CAPABILITY_IAM CAPABILITY_NAMED_IAM --profile $profile --region $region --parameter-overrides ProjectName=$project_name
